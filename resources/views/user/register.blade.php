...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2x1">
    <section>
        <h3 class="font-bold text-2x1">Welcome to Registration System</h3>
        <p class="text-gray-600 pt-2">Sign in your account <a href="/login" class="text-purple-400 font-bold">here</a></p>
    </section>
    <section class="mt-10">
